...
// Removed dynamic selection position hook — toolbar is always fixed at bottom
    ...
    <AnimatePresence>
      {isMulti && (
        <motion.div
          ...
          className="fixed bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-4 px-6 py-3 bg-surface-container-high/95 backdrop-blur-3xl rounded-full shadow-[0_24px_60px_rgba(0,0,0,0.8),0_0_0_1px_rgba(255,255,255,0.06)] border border-outline-variant/15 z-50 select-none"
        >
          <div
